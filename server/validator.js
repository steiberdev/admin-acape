...
function organizarPorDia(datos) {
    ...
    datos.forEach(item => {
        ...
        agrupados[fechaClave].egreso += item.egreso || 0;
  ...
  finalCajas_log.innerHTML = simpleCaja.map(ch => {
    return `<div class="card mt-2">
            <div class="card-header pb-0 px-3">
              ...
              <p class="mb-0 text-sm">Total Gastos: $${formatNumber(ch.egreso + ch.value_egresos)}</p>
                ...
                ${ch.data.map(item => {
                  ...
                  <li class="list-group-item border-0 d-flex p-4 mb-2 mt-3 bg-gray-100 border-radius-lg">
                    <div class="d-flex flex-column">
                      ...
                      <span class="mb-2 text-xs">Total Gastos: <span class="text-dark ms-sm-2 font-weight-bold">$ ${formatNumber(item.egreso + item.value_egresos)}</span></span>
